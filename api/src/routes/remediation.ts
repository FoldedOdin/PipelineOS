...
remediationRouter.get("/internal/remediation/rules", requireInternalApiKey, async (req, res, next) => {
  try {
...
remediationRouter.post("/internal/remediation/rules", requireInternalApiKey, async (req, res, next) => {
  try {
...
remediationRouter.post("/internal/remediation/rules/:id/outcomes", requireInternalApiKey, async (req, res, next) => {
  try {
    ...
    const ruleId = typeof paramId === "string" ? paramId : (Array.isArray(paramId) && typeof paramId[0] === "string" ? paramId[0] : "");
